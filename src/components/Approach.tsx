...
export default function Approach() {
  return <section id="approach" className="py-20 md:py-28 bg-muted/20">
      <div className="container-calm">
        ...
        <div className="max-w-2xl mb-12">
          ...
          <p className="mt-4 text-lg text-muted-foreground leading-relaxed">We use The Four Strands as a diagnostic lens — not to replace your approach, but to keep your learning diet balanced. This works alongside GPA, LAMP, or any roadmap.</p>
        </div>

        {/* Strands grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {strands.map((strand, index) => <div key={strand.title} className="card-calm text-center opacity-0 animate-fade-in-up" style={{
