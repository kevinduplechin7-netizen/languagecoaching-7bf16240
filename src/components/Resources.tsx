        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {resources.map((resource, index) => (
            <a
              ...
              className="group card-calm flex items-start gap-4 opacity-0 animate-fade-in-up focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-base font-medium text-foreground group-hover:text-primary transition-colors pr-6">
                  {resource.title}
                </h3>
              </div>
