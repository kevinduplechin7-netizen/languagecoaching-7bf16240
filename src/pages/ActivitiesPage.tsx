      ...
      <main className="pt-24 pb-16">
        <div className="container-calm">
          ...
          <nav className="mb-12 p-6 bg-muted/30 rounded-lg border border-border">
            <h2 className="text-sm font-semibold text-foreground uppercase tracking-wide mb-4">Jump to strand</h2>
            <ul className="flex flex-wrap gap-3">
              {activities.map((strand) => (
                <li key={strand.id}>
                  <a href={`#${strand.id}`} className="text-sm text-primary hover:text-primary/80 transition-colors">
                    {strand.strand}
                  </a>
                </li>
              ))}
              ...
              <section key={strand.id} id={strand.id} className="scroll-mt-24">
                ...
                <div className="space-y-3">
                  {strand.items.map((activity) => {
                    ...
                    return (
                      <div key={activity.name} className="border border-border rounded-lg overflow-hidden bg-card">
                        <button
                          type="button"
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                ...
                                <div className="p-3 bg-accent/30 rounded-lg">
                                  ...
                                  <p className="text-sm text-muted-foreground mt-1">
                                    {activity.variations.intermediate}
                                  </p>
                                </div>
                                <div className="p-3 bg-accent/30 rounded-lg">
                                  <span className="text-xs font-semibold text-primary uppercase tracking-wide">
