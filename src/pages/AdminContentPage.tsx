...
const blankForm = { title: "", slug: "", excerpt: "", content: "", category: categories[0], status: "draft" as Status, seo_title: "", seo_description: "" };
...
export default function AdminContentPage() {
  ...
  const savePost = async (event: FormEvent) => {
    ...
    setSaving(true);
    const values = { ...parsed.data, seo_title: parsed.data.seo_title || null, seo_description: parsed.data.seo_description || null, published_at: parsed.data.status === "published" ? new Date().toISOString() : null };
